...
public class UserOrdersController {
	...
	public void loadOrdersData(ArrayList<String> allReservations) {
		...
		for(String reservation : allReservations) {
			...
			Reservation receivedRez = new Reservation(parkName, orderNumber, timeOfVisit, numberOfVisitors, telphoneNumber, email);
